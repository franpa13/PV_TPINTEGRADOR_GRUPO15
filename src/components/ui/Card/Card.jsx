...
export default function CardComponent({ product }) {
    ...
    return (
        <div className="max-w-xs w-full lg:w-1/6 rounded-md overflow-hidden shadow-md border-1 border-[#DF1074]  bg-white transition-all duration-200 hover:shadow-2xl flex flex-col h-62">
            {/* Product Image */}
